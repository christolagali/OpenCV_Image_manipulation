...
public class ImageApplication extends Frame
{
 ...
 // Used for addNotify check.
 	...
 	java.awt.Label label_subtitle = new java.awt.Label();
 	//}}
	...
	public ImageApplication()
	{
		...
		label_title.setText("Lynne's Image Toolkit-by Christo lagali");

		add(label_title);

		label_title.setFont(new Font("Dialog", Font.BOLD, 14));
		label_title.setBounds(84,36,450,51);
	...
	void openMenuItem_ActionPerformed_Interaction1(java.awt.event.ActionEvent event)
	{
		try {
		    ...
		    Filename1 = (openFileDialog1.getDirectory()).concat(openFileDialog1.getFile());
	        ...
	        image_data = new ImageData(img, "JPEG", height, width);
